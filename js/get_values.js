function getSelectValue()
{
    ...
    var pathValue = `../images/mapas_novo/gerais/${selectedValue1}/${selectedValue1}_${selectedValue2}_GERAL.html`;
    // var res = `${str1} ${str2}`;
...
function getSelectValue2()
{
    ...
    var pathValue = `../images/mapas_novo/gerais/${selectedValue1}/${selectedValue1}_${selectedValue2}_${selectedValue3}.html`;
    // var res = `${str1} ${str2}`;
...
function getSelectValue3()
{
    ...
    var pathValue = `../images/mapas_novo/individuais/${selectedValue1}/${selectedValue1}_${selectedValue2}_${selectedValue3}.html`;
    // var res = `${str1} ${str2}`;
